...
- **`reports/`** 存放生成的页面。[reports/gallery.html](reports/gallery.html) 是一个**案例合集**（天津攻略、AI 速览、世界杯战报等，都可以在小程序里点开）；单看一个示例可参考 [reports/tianjin-travel-guide.html](reports/tianjin-travel-guide.html)。
